...
function educationalVideo(title, entry = '') {
  ...
  return /다큐프라임|지식채널|#EBR|강연|강의|교수|학자|연구|해설|분석/i.test(title)
    && /다큐프라임|지식채널|#EBR|철학|인권|민주|교육|학습|학교|청소년|노동|경제|사회|과학|연구|교수|학자|조직\s*문화|리더|번아웃|\bAI\b|인공지능/i.test(title);
}
