...
- `lib/video-feeds.js`: EBS 다큐·교양·비즈니스 리뷰의 공식 YouTube Atom 피드에서 최근 30일의 교육·시사 해설 영상 선별
...
영상은 선별 기사 최대 18개와 별도로 채널당 최대 2개, 총 6개를 업로드 날짜순으로 제공합니다. 홈에는 3개, 영상 탭에는 전체 수집 결과를 표시합니다. 영상 수집이 실패하거나 관련 영상이 없으면 상태 안내를 표시하며 예시 영상을 보여 주지 않습니다. 채널 목록은 `lib/video-feeds.js`에서 관리합니다. 새 업로드는 다음 예약 수집 때 반영됩니다.
...
- 영상은 EBS 공식 채널 중 교육·다큐·강연·해설 성격이 제목에서 확인되는 것을 선별합니다. 여행·생활 예능, 쇼츠, 예고, 홍보를 제외합니다. 업로드 날짜는 원방송·촬영 날짜와 다를 수 있습니다.
