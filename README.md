...
- `lib/video-feeds.js`: 조코딩·안될공학의 공식 YouTube Atom 피드에서 최근 30일의 AI 관련 영상 수집
...
영상은 기사 18개와 별도로 채널당 최대 3개, 총 6개를 업로드 날짜순으로 제공합니다. 홈에는 3개, 영상 탭에는 전체 수집 결과를 표시합니다. 영상 수집이 실패하거나 관련 영상이 없으면 상태 안내를 표시하며 예시 영상을 보여 주지 않습니다. 채널 목록은 `lib/video-feeds.js`에서 관리합니다. 새 업로드는 다음 예약 수집 때 반영됩니다.
